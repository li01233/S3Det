...
class AutoBackend(nn.Module):
    ...
    def forward(self, im,ratio_small = 1,augment=False, visualize=False):
        """
        ...
        if self.pt or self.nn_module:  # PyTorch
            y = self.model(im, ratio_small = ratio_small,augment=augment, visualize=visualize) if augment or visualize else self.model(im,ratio_small = ratio_small)
